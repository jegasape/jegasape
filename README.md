...
I started my career in programming during college by working on `C`. I successively worked on `Qt/C++` `C#` `JS/HTML/CSS` `Python` etc. I worked with some transnational companies where I contributed mostly through server-side coding in `Go` `C#` `Python` along with backend and full-stack system designing
